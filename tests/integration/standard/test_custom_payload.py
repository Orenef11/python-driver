...
class CustomPayloadTests(unittest.TestCase):
    ...
    # @pytest.mark.xfail("Scylla error: 'truncated frame: expected 65540 bytes, length is 64'")
    ...
    # @pytest.mark.xfail("Scylla error: 'Invalid query kind in BATCH messages. Must be 0 or 1 but got 4'")
    @unittest.expectedFailure
    ...
    # @pytest.mark.xfail("Scylla error: 'Got different query ID in server response (b'\x00') than we had before "
